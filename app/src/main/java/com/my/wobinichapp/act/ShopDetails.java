...
import com.my.wobinichapp.databinding.ActivityShopDetailsBinding;
...
public class ShopDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(ShopDetails.this);

        binding.llLandScape.setOnClickListener(v -> {
            startActivity(new Intent(ShopDetails.this,KolnActivityDetails.class));
        });

        binding.llMeal.setOnClickListener(v -> {
            startActivity(new Intent(ShopDetails.this,MealDetailsActivity.class));
        });

        binding.llFreetime.setOnClickListener(v -> {
            startActivity(new Intent(ShopDetails.this,FreeTimeDetailsActivity.class));
        });
        ...
        if (sessionManager.isNetworkAvailable()) {
            ...
            Toast.makeText(ShopDetails.this, R.string.checkInternet, Toast.LENGTH_SHORT).show();
        }
    }

    private void setAdapter(ArrayList<GetTypeModel.Result> modelList) {

        mAdapter = new LandScapeAdapter(ShopDetails.this,modelList);
        // binding.recyclerGrp.setHasFixedSize(true);
        // use a linear layout manager
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ShopDetails.this);
        ...
        mAdapter.SetOnItemClickListener(new LandScapeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, GetTypeModel.Result model) {
                ...
                startActivity(new Intent(ShopDetails.this, GoogleMapp.class).putExtra("lan",model.getLat()).putExtra("lon",model.getLon()));
    ...
    {
        String USER_ID= Preference.get(ShopDetails.this,Preference.KEY_USER_ID);
        Call<GetTypeModel> call = RetrofitClients
                .getInstance()
                .getApi()
                .get_wobinich_type(USER_ID,"shop");
            ...
            public void onResponse(Call<GetTypeModel> call, Response<GetTypeModel> response) {
                try {
                    ...
                    if (status.equalsIgnoreCase("1")) {
                        ...
                        Toast.makeText(ShopDetails.this, ""+message, Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
